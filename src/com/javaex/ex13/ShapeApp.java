...
public class ShapeApp {
	...
	public static void main(String[] args) {
		...
		Rectangle r02 = new Rectangle("파랑","노랑", 10, 10);
...
//			System.out.println(cArray[i].getLineColor());
			cArray[i].draw();
		}
		
		//삼각형
		Triangle t01 = new Triangle("파랑", "빨강", 40, 30);
		Triangle t02 = new Triangle("보라", "노랑", 20, 30);
		Triangle t03 = new Triangle("초록", "빨강", 15, 15);
		//배열
